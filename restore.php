<?php
    ...
    if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $sql = "UPDATE Users SET Parole='$naujas', LastTimeActive='$date', IP='$IP' WHERE ID='$ID'";
    ...
    if($pavyko==true)
    {
        ...
        $email->Subject = 'Jūsų paskyros „Šalys ir sostinės” slaptažodis pakeistas';
        ...
        <img src='https://countries-capitals.com/images/restore_completed.png' alt='El. paštas patvirtintas' width='512' height='512' style='display: block;' />
        </td>
        </tr>
        <tr>
